...
--- Created by muescha.
--- DateTime: 16.12.22 23:33
--- Source: https://github.com/insanum/dotfiles/blob/master/hammerspoon/notifications.lua
...
function clearNotification(doubleClick)
    ...
    elseif (pmon.w == 1728) and (pmon.h == 1079) then
        clickPoint = { x=1371, y=59 }
    else
        print("Unknown monitor (size w="..pmon.w.." h="..pmon.h..")")
        print("mouse is now here: " .. hs.inspect(mouseOrigin))
        return
    end
...
hs.hotkey.bind({ "cmd", "ctrl" }, "o", keyInfo("Clear the top notification"),
        function()
            clearNotification(false)
        end)

hs.hotkey.bind({ "cmd", "ctrl", "shift" }, "o", keyInfo("Clear the top notification group"),
        function()
