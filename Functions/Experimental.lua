...
--- Created by muescha.
--- DateTime: 16.12.22 20:00
---
--- Source: https://github.com/dbalatero/dotfiles/blob/master/hammerspoon/experimental.lua#L424
---
---
fileInfo()
...
function getCurrentPositionAsync(callbackFn)
 ...
 hs.hotkey.bind(super, '1', keyInfo("Test1 getCurrentPositionAsync"), function()
   getCurrentPositionAsync(function(position)
     logger.i("Got position " .. inspect(position))
   end)
 end)

hs.hotkey.bind(super, '9', keyInfo("Test2 Pasteboardtimer"), function()
    local startTimeNs = hs.timer.absoluteTime()
...
hs.hotkey.bind(super, '8', keyInfo("Test3 Pasteboardtimer"), function()
    local startTimeNs = hs.timer.absoluteTime()
    local initialCount = hs.pasteboard.changeCount()
    local pasteboardTimer
    local timeoutTimer

    local callbackFn = function(position)
        logger.i("callbackFn Got position " .. inspect(position))
    end
...
-- hs.hotkey.bind(hyper, 'r', setFieldValue)
 ...
 hs.hotkey.bind(super, '3', keyInfo("Test4 Pasteboardtimer"), function()
   local systemElement = ax.systemWideElement()
   local currentElement = systemElement:attributeValue("AXFocusedUIElement")
...
hs.hotkey.bind(hyper, '2', keyInfo("Test5 getCursorPositionManually"), getCursorPositionManually)
...
hs.hotkey.bind(super, '4',keyInfo("Test6 Overlay"), function()
...
hs.hotkey.bind(super, '6', keyInfo("Test7 editableAncestor"),function()
    local systemElement = ax.systemWideElement()
    local currentElement = systemElement:attributeValue('AXFocusedUIElement')
...
hs.hotkey.bind(hyper, '7', keyInfo("Test8 DrawBoxAbove"),function()
    local systemElement = ax.systemWideElement()
    local currentElement = systemElement:attributeValue('AXFocusedUIElement')
    --debugElement(currentElement)
...
hs.hotkey.bind(hyper, '5',keyInfo("Test9 getSelectedTextRange"), function()
