--- https://github.com/jacegem/hammerspoon/blob/master/modules/select_window.lua
--- but new version available:
---   https://raw.githubusercontent.com/jacegem/hammerspoon/master/modules/select_window.lua
